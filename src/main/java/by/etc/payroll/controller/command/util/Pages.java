...
public interface Pages {
    ...
    String REDIRECT_PAGE_SUCCESS_BLOCK_ACCOUNT = "/controller?command=showaccount&number=%s&sucblock=true";
    String REDIRECT_PAGE_SUCCESS_CREATE_NEW_ACCOUNT = "/controller?command=mainpage&msg=success";
    String REDIRECT_PAGE_AFTER_UNSUCCESS_CREATE_NEW_ACCOUNT = "/controller?command=newaccountpage&";

    String JSP_NEW_ACCOUNT_PAGE = "WEB-INF/jsp/home/new_account.jsp";
    String JSP_SHOW_ACCOUNT_PAGE = "WEB-INF/jsp/home/show_account.jsp";
    String REDIRECT_PAGE_AFTER_SUCCESS_UNBLOCKACCOUNT = "/controller?command=showaccount&number=%s&sucunblock=true";
    String REDIRECT_PAGE_SUCCESS_BLOCK_CARD = "/controller?command=showcardpage&cid=%d&blocksuccess=true";
    String REDIRECT_PAGE_SUCCESS_DELETE_CARD = "/controller?command=mainPage&scdrop=true";
